var isbot = (function (exports) {
    ...
    var list$1 = list;
    var regex = new RegExp('(' + list$1.join('|') + ')', 'ig');
    ...
    var extend = function(additionalFilters){
        list$1 = list$1.concat(additionalFilters);
        regex = new RegExp('(' + list$1.join('|') + ')', 'ig');
    };
    isbot.extend = extend;
